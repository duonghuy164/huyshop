    	...
    	<div class="row">
            <div class="col-sm-8">
                ...
                <div class="resp-tabs-container hor_1" style="border-color: rgb(193, 193, 193);margin-top: 10px;">
                    <div class="resp-tab-content hor_1 resp-tab-content-active" aria-labelledby="hor_1_tab_item-0" style="display:block">
                        <div class="vertical_post check_box_agile">
                            <h5><i class="fas fa-people-carry"></i></i> Phương thức vận chuyển</h5>
                            <div class="checkbox">
                                <div class="check_box_one cashon_delivery">
                                    <label class="anim">
                                        ...
                                        <span style="float: right; margin-left: 240px;"> 20000VNĐ</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="checkbox">
                                <div class="check_box_one cashon_delivery">
                                    <label class="anim">
                                        ...
                                        <p style="margin-left: 10px;float: left;">{{ $price}}VNĐ</p>
                                    </label>
                                    <label class="anim">
                                        <p style="float: left;font-weight: bold;">Phí vận chuyển</p>
                                        <p style="margin-left: 10px;float: left;">20000VNĐ</p>
                                    </label>
                                      </label>
                                    <label class="anim">
                                        <p style="float: left;font-weight: bold; color: red">Tổng:</p>
                                        <p style="margin-left: 10px;float: left; color: red" class="paytotal">{{ $price+20000 }}VND</p>
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="vertical_post check_box_agile">
                            <div class="checkbox">
                                <div class="check_box_one cashon_delivery">
                                    <label class="anim">
                                        <p style="float: left;font-weight: bold; color: red">Tổng: </p>
                                        <p style="margin-left: 3px;float: left; color: red">{{ $price+20000 }}VNĐ</p>
                                    </label>
                                    <label class="anim">
                ...
                <div class="modal-body">
                    <form method="post" action="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control phone" placeholder="Nhập số điện thoại" name="phone" required value="">
