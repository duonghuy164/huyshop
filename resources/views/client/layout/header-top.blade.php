                    ...
                    <li class="text-center border-right text-white">
						...
						<li class="text-center text-white">
							<a href="#" data-toggle="modal" data-target="#exampleModal2" class="text-white">
								<i class="fas fa-sign-out-alt mr-2"></i>Sign up </a>
						</li>
				...
				<div class="modal-body">
					<form action="{{ route('login') }}" method="post">
						...
						<div class="right-w3l">
							...
							<a href="login/facebook" class="btn btn-primary form-control">Đăng nhập bằng faccebook </a>
						</div>
				...
				<div class="modal-body">
					<form action="{{ route('signup') }}" method="post">
						...
						<div class="form-group">
							...
							<input type="password" class="form-control" placeholder="Nhập lại" name="password2" id="password2" required="">
